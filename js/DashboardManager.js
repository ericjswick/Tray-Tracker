                            ...
                            <div class="modal-body">
                                ...
                                <div class="calendar-options">
                                    ...
                                    <div class="d-grid gap-2">
                                        <button class="btn btn-primary" onclick="window.app.dashboardManager.addToGoogleCalendar('${caseId}')">
                                            <i class="fab fa-google me-2"></i>Add to Google Calendar
                                        </button>
                                        <button class="btn btn-secondary" onclick="window.app.dashboardManager.downloadICS('${caseId}')">
